define(['app'], function(app) {
  app.registerService(
    ...
    function() {    	
    	...
    	this. getHMAC = function(hashInput, privateKey) {
    		try {
    			hashInput = hashInput + '';
    	...
    	this.calcHash = function(hashInput) {
    		try {
    			hashInput = hashInput + '';
    	...
    	this.copyObject = function (srcObj, dstObj){
    	...
    	this.moveArrayElement = function(arr, fromIndex, toIndex) {
    		if(arr == null){
    			return;
    		}
    	...
    	this.getTheDateOfNextYear = function (){
    		var date = new Date();
